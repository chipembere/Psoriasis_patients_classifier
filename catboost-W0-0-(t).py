...
# load the datasets
dataframe = pd.read_excel(r"data_for_classification.xlsx")
...
ax.set_alpha(0.8)
ax.set_title('%s Performance on Baseline Values'%(m_name),fontsize=18)
...
ax.set_alpha(0.8)
ax.set_title('%s Model Validation on Unseen Data (baseline)'%(m_name),fontsize=16)
ax.set_ylabel("%", fontsize=13);
ax.set_yticks(np.arange(0, 100, step=5))
l0=log.loc['W0-0','Inde_x'] 
#l1=log.loc['W0-1','Inde_x'] 
