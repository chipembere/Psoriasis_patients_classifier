...
X_groups = [df0, df1, df2,df3,df4,df5,df6]
combinations = ['W0-0', 'W0-1', 'W0-2', 'W0-3', 'W0-4', 'W0-5','W0-6']
...
#    # Impute missing values.
    ...
    for train, test in rskf.split(X, y):
        ...
        # Save trained model
        #model.save_model('mods/%s_CatTb%0.2f_model.cbm'%(zita, i))
...
ax.set_alpha(0.8)
ax.set_title('%s Performance (d)'%(m_name),fontsize=18)
ax.set_ylabel("%", fontsize=13);
ax.set_yticks(np.arange(0, 100, step=5))
l0=log.loc['W0-0','Inde_x']
...
#    model = model.load_model('mods/%s_CatTb%0.2f_model.cbm'%(zita, i))
...
#ax.set_alpha(0.8)
#ax.set_title('%s Trained Model Validation On Unseen Data (d)'%(m_name),fontsize=16)
#ax.set_ylabel("%", fontsize=13);
#ax.set_yticks(np.arange(0, 100, step=5))
#l0=log.loc['W0-0','Inde_x'] 
#l1=log.loc['W0-1','Inde_x'] 
...
#        #model.predict(X_66) #save it to some list
#        # Save trained model
#        #model.save_model('minez2/%s_CatT%0.2f_model.cbm'%(zita, i))
#        
#        i += 1
#
#    # mean true_positives.
...
#ax = log[['AUC', 'Accuracy', 'A_PR']].plot(kind='bar', width=0.8 ,figsize=(14,8), color=['dodgerblue', 'slategray', 'brown'], fontsize=13);
#ax.set_alpha(0.8)
#ax.set_title('%s Performance on Merged Set (d)'%(m_name),fontsize=18)
#ax.set_ylabel("%", fontsize=13);
#ax.set_yticks(np.arange(0, 100, step=5))
#l0=log.loc['W0-0','Inde_x']
#l1=log.loc['W0-1','Inde_x'] 
